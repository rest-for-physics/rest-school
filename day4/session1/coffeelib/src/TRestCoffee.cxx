...
///                                                                      
/// YEAR-Month: First implementation of TRestCoffee
...
ClassImp(TRestCoffee);

///////////////////////////////////////////////                          
/// \brief Default constructor                                          
///                                                                      
TRestCoffee::TRestCoffee() {
    Initialize();
}
...
/// corresponding TRestCoffee section inside the RML.
///
TRestCoffee::TRestCoffee(const char* configFilename, std::string name) : TRestMetadata(configFilename) {
...
/// the section name                                                     
///                                                                      
void TRestCoffee::Initialize() {
    SetSectionName(this->ClassName());
    // REMOVE COMMENT. Remove SetLibraryVersion line code if
    // your metadata class is a framework class.
