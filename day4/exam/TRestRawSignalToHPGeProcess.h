...
#ifndef RESTProc_TRestRawSignalToHPGeProcess
#define RESTProc_TRestRawSignalToHPGeProcess
...
class TRestRawSignalToHPGeProcess : public TRestEventProcess {
private:
    /// A pointer to the specific TRestRawSignalEvent input event
    TRestRawSignalEvent* fInputRawSignalEvent;  //!
    /// A pointer to the specific TRestHPGeEvent output event
    TRestHPGeEvent* fOutputHPGeEvent;  //!
...
public:
    ...
    any GetOutputEvent() const override { return fOutputHPGeEvent; }
