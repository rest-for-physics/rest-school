...
///                                                                      
/// YEAR-Month: First implementation of TRestRawSignalToHPGeProcess
/// WRITE YOUR FULL NAME 
///                                                                      
/// \class TRestRawSignalToHPGeProcess                                               
...
ClassImp(TRestRawSignalToHPGeProcess);

///////////////////////////////////////////////                          
/// \brief Default constructor                                          
///                                                                      
TRestRawSignalToHPGeProcess::TRestRawSignalToHPGeProcess() {
    Initialize();
}
...
/// the section name                                                     
///                                                                      
void TRestRawSignalToHPGeProcess::Initialize() {
    SetSectionName(this->ClassName());
    SetLibraryVersion(LIBRARY_VERSION);
    fInputRawSignalEvent = NULL;
    fOutputHPGeEvent = new TRestHPGeEvent();
...
/// might be added here.                                                 
///                                                                      
void TRestRawSignalToHPGeProcess::InitProcess() {
...
///                                                                      
TRestEvent* TRestRawSignalToHPGeProcess::ProcessEvent(TRestEvent * evInput) {
    fInputRawSignalEvent = (TRestRawSignalEvent*)evInput;

    // Write here the main logic of process: TRestRawSignalToHPGeProcess
    // Read data from input event, write data to output event, and save observables to tree

    return fOutputHPGeEvent;
}
...
/// processed.                                                            
///                                                                       
void TRestRawSignalToHPGeProcess::EndProcess() {
